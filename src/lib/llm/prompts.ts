...
/*export const quizUserPromptTemplate = (contextText: string, globalDifficulty: string, questionTypes: string[]) => `
...
export const quizSystemPrompt = (withInspirationFiles: boolean) => `
...
export const quizUserPromptTemplate = (
  contextText: string,
